...
class HudView: UIView{
    ...
    func show(animated: Bool){
        if animated{
            ...
            UIView.animate(withDuration: 0.3, delay: 0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.5, options: .transitionFlipFromBottom, animations: {
                self.alpha = 1
